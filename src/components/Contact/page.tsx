...
const page = () => {
  return (
    <div className="w-[78%] mx-auto flex justify-between items-center px-10 py-10 min-h-[80vh] bg-white">
      <div className="w-[45%] space-y-6 text-gray-800">
        <div className="flex items-start space-x-3">
          <FaMapMarkerAlt className="text-blue-900 mt-1" />
          <p className="mt-4 text-lg text-gray-900 max-w-4xl">
        ...
        <div className="flex items-center space-x-3">
          ...
          <a
            ...
            className="text-blue-900 text-xl hover:underline mb-6"
          >
            +2348055544513
          </a>
        </div>
      ...
      <div className="w-[45%]">
        <form className="space-y-4">
          ...
          <div className="flex justify-start">
            <button
              type="submit"
              className="bg-blue-900 text-white px-8 py-4 rounded-md hover:bg-blue-900"
            >
              CONTACT US
            </button>
          </div>
